...
const API_ID = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('trello-api-key', { required: true });
const AUTH_TOKEN = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('trello-auth-token', { required: true });
const BOARD_ID = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('trello-board-id', { required: true });
const CARD_ID = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('trello-card-id', { required: true });
const MESSAGE = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('trello-message', { required: true });
class Trello {
    params;
    /**
     *
     ...
     */
    async addCommentToCard(card, message) {
        ...
        await axios__WEBPACK_IMPORTED_MODULE_1___default().post(`${url}?${query}`);
    }
    /**
     *
     * @param cardId
...
(async () => {
    try {
        ...
        if (axios__WEBPACK_IMPORTED_MODULE_1___default().isAxiosError(err)) {
            return _actions_core__WEBPACK_IMPORTED_MODULE_0__.error(`[${err.response.config.method.toUpperCase()}] ${err.response.config.url} : ${err.response.status} ${err.response.statusText} (${err.response.data ?? ''})`);
        }
        _actions_core__WEBPACK_IMPORTED_MODULE_0__.error(err.toString());
        console.error(err);
    }
})();
