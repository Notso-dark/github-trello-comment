...
(async() => {
    try {
        const trello = new Trello({
            apiKey: _actions_core__WEBPACK_IMPORTED_MODULE_1__.getInput('trello-api-key', { required: true }),
            authToken: _actions_core__WEBPACK_IMPORTED_MODULE_1__.getInput('trello-auth-token', { required: true }),
            boardId: _actions_core__WEBPACK_IMPORTED_MODULE_1__.getInput('trello-board-id', { required: true }),
            cardId: _actions_core__WEBPACK_IMPORTED_MODULE_1__.getInput('trello-card-id', { required: true }),
            message: _actions_core__WEBPACK_IMPORTED_MODULE_1__.getInput('trello-message', { required: true })
        })
        await trello.run()
    } catch(err) {
        _actions_core__WEBPACK_IMPORTED_MODULE_1__.error(err)
    }
})()
